...
const QualitySection = styled(Box)(({ theme, isDarkMode }) => ({
  marginTop: '24px',
  paddingLeft: '16px',
  borderLeft: `4px solid ${isDarkMode ? '#FFB74D' : '#FF9800'}`,
  marginLeft: '-20px',
  paddingTop: '8px',
  background: isDarkMode
    ? 'linear-gradient(135deg, rgba(255, 152, 0, 0.1) 0%, rgba(255, 152, 0, 0.05) 100%)'
  ...
  const renderDetailSection = (title, content, icon) => {
    ...
    return (
        <SectionContainer> 
          ...
          <Divider sx={{ mb: 2, borderColor: isDarkMode ? 'rgba(255, 255, 255, 0.1)' : 'rgba(255, 152, 0, 0.2)' }} /> 
          <SectionContent>
          ...
          <DetailCard elevation={0} isDarkMode={isDarkMode}>
            {loading ? (
              ...
              <Box>
                  ...
                  > 
                    <Box flexGrow={1}>
                      <MainTitle isDarkMode={isDarkMode}>
                        <PendingActions sx={{ fontSize: '2rem', verticalAlign: 'middle', mr: 1, color: '#FF9800' }} />
                        {lessonDetail.lesson || 'Chi Tiết Giáo án'}
                      </MainTitle>
                      <StatusChip
                        icon={<HourglassTop />}
                ...
                {renderDetailSection("Mục tiêu", lessonDetail.goal, <Assignment sx={{ color: '#FF9800', fontSize: '1.8rem' }} />)}
                {renderDetailSection("Giáo viên chuẩn bị", lessonDetail.schoolSupply, <Build sx={{ color: '#FF9800', fontSize: '1.8rem' }} />)} 
                {renderDetailSection("Hoạt động Khởi động", lessonDetail.startUp, <Typography sx={{fontWeight: 'bold', color: '#FF9800', fontSize: '1.8rem'}}>1.</Typography>)}
                {renderDetailSection("Hoạt động Hình thành Kiến thức", lessonDetail.knowledge, <Typography sx={{fontWeight: 'bold', color: '#FF9800', fontSize: '1.8rem'}}>2.</Typography>)}
                {renderDetailSection("Hoạt động Luyện tập", lessonDetail.practice, <Typography sx={{fontWeight: 'bold', color: '#FF9800', fontSize: '1.8rem'}}>3.</Typography>)}
                {renderDetailSection("Hoạt động Vận dụng", lessonDetail.apply, <Typography sx={{fontWeight: 'bold', color: '#FF9800', fontSize: '1.8rem'}}>4.</Typography>)}
              </Box>
            ) : (
...
export default PendingLessonDetail; 